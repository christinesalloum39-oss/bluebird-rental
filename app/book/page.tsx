      ...
      <div className="w-full max-w-[580px]">
        ...
        <div className="flex justify-center mb-6">
          <Link href="/" className="flex items-center gap-3">
            ...
            <span className="font-barlow font-black text-white text-[1.3rem] tracking-tight">
              Blue<span style={{ color:"#A855F7" }}>Bird</span>
            </span>
          </Link>
        </div>

        {/* Booking form card */}
        <div className="w-full rounded-2xl overflow-hidden shadow-2xl shadow-purple-900/50"
          ...
          <div className="px-5 sm:px-6 py-5 flex flex-col gap-4 min-w-0">
            ...
            {/* Make a Reservation — intentionally inert for now */}
            <button
              type="button"
        ...
        <div className="text-center mt-6">
          <Link href="/" className="text-white/40 hover:text-white/70 text-[.8rem] transition-colors inline-flex items-center gap-1.5">
